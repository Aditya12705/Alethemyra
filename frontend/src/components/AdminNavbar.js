  ...
  return (
    <nav style={{
      ...
      <div style={{ 
        ...
        height: 45,
        alignItems: 'center'      }}>
        <Link to="/admin-dashboard/" style={getNavLinkStyle('/')}>Applications</Link>
        <Link to="/admin-dashboard/crust-score" style={getNavLinkStyle('crust-score')}>Crust Score</Link>
        <Link to="/admin-dashboard/users" style={getNavLinkStyle('users')}>Users</Link>
      </div>
    </nav>
  );
};
